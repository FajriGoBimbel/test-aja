...
const SoalGOA = () => {
  ...
  const [answerStatus, setAnswerStatus] = useState(Array(15).fill("belum"));
      ...
      <div className="container mx-auto my-12 flex justify-between flex-row-reverse flex-wrap">
        ...
        <div className="timer w-full md:w-1/3">
          ...
          <div className="mt-4 md:mt-12 max-w-fit mx-auto md:float-right">
            <h5 className="mb-4 font-semibold text-base uppercase">
              GO ASSESMENT (GOA)
            </h5>
        ...
        <div className="w-full md:w-2/3 px-4 md:px-4 mt-8 md:mt-0">
          <div className="flex gap-x-2 items-center mb-6">
            ...
            <div>
              <h1 className="mb-1 uppercase font-bold">GO ASSESMENT (GOA)</h1>
              <h2>Bagian A</h2>
            </div>
          </div>
          {/* Modal */}
          ...
          >
            ...
            >
              ...
              {/* START:Content */}
              <h1 className="uppercase text-center text-2xl font-semibold mb-4">
                GO ASSESMENT (GOA)
              </h1>
              <p>
                Jika keluar tanpa mengumpulkan soal, maka soal belum dijawab
                akan dianggap kosong oleh sistem. Tombol `Kumpulkan` hanya aktif
                di nomor terakhir GO ASSESMENT.
                <div className="mt-4" />
                Apakah kamu yakin ingin keluar tanpa menyelesaikan soal?
              </p>
              {/* END:Content */}
          ...
          <div className="flex gap-x-8 items-center justify-end">
            ...
            >
              ...
              >
                ...
                <p>
                  Setelah mengumpulkan go assesment ini, kamu tidak akan bisa
                  kembali mengerjakan soal lagi. Yakin mau mengumpulkan dan
                ...
                <div className="flex justify-end gap-x-4 items-center mt-6">
                  <button
                    onClick={handleSubmit}
                    className="outline-shadow-button !py-3 !px-6 text-xs"
                  >
                    Tidak, Kembali
                  </button>
                  <button
...
SoalGOA.getLayout = (page: any) => {
  return <BlankLayout>{page}</BlankLayout>;
};

export default SoalGOA;
